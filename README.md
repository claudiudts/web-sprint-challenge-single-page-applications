...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
   1. The useRouteMatch hook attempts to match the current URL in the same way that a <Route> would.
2. How would you explain form validation to someone who has never programmed before?
   1. Form validation is used to make sure that the user types in the correct information and it matches to the required params put in place by the developer, for example on an a password it might get validated if it has a capital letter and a special symbol in the password.
3. In 1-2 sentences, define end to end testing.
   1. it is testing an applications workflow from start to end. It is used to replicate real world and user scenarios . 
